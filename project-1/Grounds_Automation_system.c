    ...
    if(strcmp(grounds[i].city,cityv)==0){
      for(int j=0;j<5;j++){
         for(int k=0;k<4;k++)
         {
             ...
             {
               if(strcmp( grounds[i].g[j].d[k].scstarttime,startt)<=0){
                    if(strcmp( grounds[i].g[j].d[k].scendtime,endt)>=0){
                ...
                if(strcmp( grounds[i].g[0].d[0].scdate,grounds[i].g[j].d[k].scdate)>0)
                 {
                   ...
                   strcpy(grounds[i].g[0].d[0].scdate,grounds[i].g[j].d[k].scdate);
